...
<?php echo $this->Form->create('Convenio'); ?>
	<fieldset>
		<legend><?php echo __('Edit Convenio'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Convenio.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Convenio.id'))); ?></li>
