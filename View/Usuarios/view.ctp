...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Remover Usuario'), array('action' => 'delete', $usuario['Usuario']['id']), array(), __('Você tem certeza que deseja remover %s?', $usuario['Usuario']['login'])); ?> </li>
